...
The formal writeup should look like below. Each section should address concepts given below. \inred{You will do your own, individual writeup. No copying from others. No paraphrasing from others.} You may do more than what is listed below; you can include figures, tables, illustrations if you believe it helps relate what you have done.\\
