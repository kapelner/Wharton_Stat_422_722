...
You will then have one day to predict the selling prices of a set a of 947 apartments currently on the market found in the \href{https://github.com/kapelner/Wharton_Stat_422_722/blob/master/assignments/project/stat_422_722_project_prediction_set.csv}{prediction CSV file}. 
...
I will then wait until the grading deadline May 12 or until 100 apartments are sold. I estimate 2-3 apartments sell per day of the 947 on this sheet thus we will have a nice set to evaluate \emph{your} future predictions against.
