...
\date{Due \textit{4th floor JMHH} Thursday, February 9 5PM\\ \vspace{0.5cm} \footnotesize (this document last updated \today ~at \currenttime)}
}
...
\problem{We will be investigating dredging and multiple testing corrections.}
