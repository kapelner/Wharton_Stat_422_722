...
\title{STAT 422/722 Spring 2016 Homework \#3}
...
\hardsubproblem{What would be the problem with allowing for all bins (if the computer can crunch the numbers) in a forward stepwise procedure?}\spc{4}
